...
const FirstStep = (props) => {
    ...
    const onSubmit = useCallback((value) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            ...
            if (!response.body) {
                throw new Error(t('generation_failed', 'Failed to generate posts, please try again.'));
            }
            const reader = response.body.getReader();
            const load = yield generateStep(reader);
            if (!(load === null || load === void 0 ? void 0 : load.content)) {
                throw new Error(t('generation_failed', 'Failed to generate posts, please try again.'));
            }
            ...
            toaster.show((e === null || e === void 0 ? void 0 : e.message) ||
                t('generation_failed', 'Failed to generate posts, please try again.'), 'warning');
        }
        finally {
            setShowStep('');
            setLoading(false);
