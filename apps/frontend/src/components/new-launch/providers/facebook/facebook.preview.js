...
import { FACEBOOK_PRESET_MAX_CHARS } from "../../../../../../../libraries/nestjs-libraries/src/dtos/posts/providers-settings/facebook.dto";
...
export const FacebookPreview = (props) => {
    ...
    const control = (_a = useFormContext()) === null || _a === void 0 ? void 0 : _a.control;
    const preset = useWatch({ control, name: 'text_format_preset_id' });
    const firstText = stripHtmlValidation('normal', ((_b = topValue === null || topValue === void 0 ? void 0 : topValue[0]) === null || _b === void 0 ? void 0 : _b.content) || '', true);
    const background = !!preset &&
        !((_d = (_c = topValue === null || topValue === void 0 ? void 0 : topValue[0]) === null || _c === void 0 ? void 0 : _c.image) === null || _d === void 0 ? void 0 : _d.length) &&
    ...
    return (<div className="py-[15px] flex flex-col px-[15px] w-full gap-[20px] bg-bgFacebook rounded-[12px]">
      ...
      {background ? (<div className="-mx-[15px] min-h-[320px] flex items-center justify-center text-center px-[32px] py-[32px] text-[28px] font-[700] leading-[36px] whitespace-pre-line break-words" style={{ background: background.background, color: background.text }} dangerouslySetInnerHTML={{
                __html: (_e = renderContent === null || renderContent === void 0 ? void 0 : renderContent[0]) === null || _e === void 0 ? void 0 : _e.text,
            }}/>) : (<div className="text-[14px] font-[400] whitespace-pre-line" dangerouslySetInnerHTML={{
                __html: (_f = renderContent === null || renderContent === void 0 ? void 0 : renderContent[0]) === null || _f === void 0 ? void 0 : _f.text,
            }}/>)}
      {!!((_h = (_g = renderContent === null || renderContent === void 0 ? void 0 : renderContent[0]) === null || _g === void 0 ? void 0 : _g.images) === null || _h === void 0 ? void 0 : _h.length) && (<div className="h-[280px] -mx-[15px] overflow-hidden flex">
          {(_j = renderContent === null || renderContent === void 0 ? void 0 : renderContent[0]) === null || _j === void 0 ? void 0 : _j.images.map((image, index) => (<a key={`image_${index}`} className="flex-1" href={mediaDir.set(image.path)} target="_blank">
