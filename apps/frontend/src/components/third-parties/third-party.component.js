        ...
        <div className="flex gap-[12px] flex-col">
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex-1 flex flex-col gap-[14px]">
              <div className={clsx('gap-[16px] flex flex-col relative justify-center rounded-e-[8px]')}>
                {!isLoading && !(data === null || data === void 0 ? void 0 : data.length) ? (<div>No Integrations Yet</div>) : (data === null || data === void 0 ? void 0 : data.map((p) => (<div key={p.id} className={clsx('flex gap-[8px] items-center group/profile hover:bg-boxHover')}>
                      <div className="h-full w-[4px] rounded-s-[3px] opacity-0 group-hover/profile:opacity-100 transition-opacity">
                        <SVGLine />
                      </div>
                      <div className={clsx('relative rounded-full flex justify-center items-center')} data-tooltip-id="tooltip" data-tooltip-content={p.title}>
