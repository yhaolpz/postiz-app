...
export function postWorkflowV104(_a) {
    return __awaiter(this, arguments, void 0, function* ({ taskQueue, postId, organizationId, postNow = false, }) {
        ...
        if (!postNow && post.state !== 'QUEUE') {
            yield changeState(postsListBefore[0].id, 'ERROR', 'Already posted', postsListBefore);
            return;
        }
        ...
        while (list.length > 0) {
            ...
            if (todo.type === 'repeat-post') {
                yield startChild(postWorkflowV104, {
...
//# sourceMappingURL=post.workflow.v1.0.4.js.map