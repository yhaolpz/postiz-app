...
function slimPost(post) {
    if (!post)
        return post;
    const { error, childrenPost, tags, description, title, submittedForOrderId, submittedForOrganizationId, submittedForOrder, submittedForOrganization, lastMessageId, parentPostId, approvedSubmitForOrder, deletedAt, createdAt, updatedAt, payoutProblems, comments, errors } = post, rest = __rest(post, ["error", "childrenPost", "tags", "description", "title", "submittedForOrderId", "submittedForOrganizationId", "submittedForOrder", "submittedForOrganization", "lastMessageId", "parentPostId", "approvedSubmitForOrder", "deletedAt", "createdAt", "updatedAt", "payoutProblems", "comments", "errors"]);
    return rest;
}
let PostActivity = class PostActivity {
    ...
    updatePost(id, postId, releaseURL) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._postService.updatePost(id, postId, releaseURL);
        });
    }
    getPost(orgId, postId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const post = yield this._postService.getPostById(postId, orgId);
            if (post.deletedAt) {
                return false;
            }
            return post;
    ...
    postSocial(integration, posts) {
        return __awaiter(this, void 0, void 0, function* () {
            if (process.env.STRIPE_SECRET_KEY) {
                const subscription = yield this._subscriptionService.getSubscription(integration.organizationId);
                if (!subscription) {
    ...
    inAppNotification(orgId_1, subject_1, message_1) {
        return __awaiter(this, arguments, void 0, function* (orgId, subject, message, sendEmail = false, digest = false, type = 'success') {
            yield this._notificationService.inAppNotification(orgId, subject, message, sendEmail, digest, type);
        });
    }
    ...
    changeState(id, state, err, body) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._postService.changeState(id, state, err, body);
        });
    }
    ...
    sendWebhooks(postId, orgId, integrationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield Promise.all(webhooks.map((webhook) => __awaiter(this, void 0, void 0, function* () {
                try {
    ...
    processInternalPlug(data) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._integrationService.processInternalPlug(data);
        });
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [String, String]),
    __metadata("design:returntype", Promise)
], PostActivity.prototype, "getPost", null);
__decorate([
    ActivityMethod(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String]),
