...
let PermissionsService = class PermissionsService {
    ...
    check(orgId, created_at, permission, requestedPermission, refreshChannelId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            for (const [action, section] of requestedPermission) {
                ...
                if (section === Sections.CHANNEL) {
                    ...
                    if (refreshChannelId) {
                        const existingIntegration = yield this._integrationService.getIntegrationById(orgId, refreshChannelId);
