...
let PoliciesGuard = class PoliciesGuard {
    ...
    canActivate(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-expect-error
            const { org } = request;
            const refreshChannelId = typeof ((_a = request.query) === null || _a === void 0 ? void 0 : _a.refresh) === 'string' ? request.query.refresh : undefined;
            // @ts-ignore
            const ability = yield this._authorizationService.check(org.id, org.createdAt, org.users[0].role, policyHandlers, refreshChannelId);
