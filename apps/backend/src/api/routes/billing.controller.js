...
let BillingController = class BillingController {
    constructor(_subscriptionService, _stripeService, _notificationService) {
    ...
    chatbaseRefundPreview(org) {
        return this._stripeService.chatbaseRefundPreview(org.id);
    }
    chatbaseRefund(user, org) {
        return __awaiter(this, void 0, void 0, function* () {
            const refund = yield this._stripeService.chatbaseRefund(org.id);
            if (refund.refunded) {
                yield this._notificationService.sendEmail(process.env.EMAIL_FROM_ADDRESS, 'Refund issued from Chatbase', `Organization ${org.name} received a refund of ${refund.amount} ${refund.currency} and their subscription was cancelled`, user.email);
            }
            return refund;
        });
    }
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
], BillingController.prototype, "chatbaseRefundPreview", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Object, Object]),
    __metadata("design:returntype", Promise)
], BillingController.prototype, "chatbaseRefund", null);
__decorate([
