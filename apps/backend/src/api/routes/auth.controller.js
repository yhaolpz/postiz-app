...
let AuthController = class AuthController {
    ...
    mobileCallback(code, state, response) {
    ...
    oauthExists(code, redirect_uri, provider, response) {
        return __awaiter(this, void 0, void 0, function* () {
            const { jwt, token } = yield this._authService.checkExists(provider, code, redirect_uri);
            if (token) {
...
], AuthController.prototype, "mobileCallback", null);
__decorate([
    Get('/oauth/:provider'),
...
__decorate([
    ...
    __param(0, Body('code')),
    __param(1, Body('redirect_uri')),
    __param(2, Param('provider')),
