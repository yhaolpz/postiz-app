...
import { ImportMediaDto } from "../../../../../libraries/nestjs-libraries/src/dtos/third-party/import-media.dto";
let ThirdPartyController = class ThirdPartyController {
    ...
    importMedia(organization, id, body) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const thirdParty = yield this._thirdPartyManager.getIntegrationById(organization.id, id);
            if (!thirdParty) {
            ...
            const downloadUrls = yield ((_b = (_a = thirdPartyInstance === null || thirdPartyInstance === void 0 ? void 0 : thirdPartyInstance.instance) === null || _a === void 0 ? void 0 : _a['importMedia']) === null || _b === void 0 ? void 0 : _b.call(_a, AuthService.fixedDecryption(thirdParty.apiKey), body.items));
            if (!downloadUrls || !Array.isArray(downloadUrls)) {
                throw new HttpException('Import not supported', 400);
            }
            const results = [];
            for (const item of downloadUrls) {
                const file = yield this.storage.uploadSimple(item.url);
                const saved = yield this._mediaService.saveFile(organization.id, item.name || file.split('/').pop(), file);
                results.push(saved);
            }
            return results;
        });
...
__decorate([
    ...
    __param(2, Body()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String, ImportMediaDto]),
    __metadata("design:returntype", Promise)
], ThirdPartyController.prototype, "importMedia", null);
__decorate([
    Post('/:identifier'),
    __param(0, GetOrgFromRequest()),
