...
let IntegrationsController = class IntegrationsController {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return {
                integrations: yield Promise.all((yield this._integrationService.getIntegrationsList(org.id)).map((p) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return Object.assign(Object.assign({ name: p.name, id: p.id, internalId: p.internalId, disabled: p.disabled, editor: findIntegration.editor, stripLinks: !!((_a = findIntegration === null || findIntegration === void 0 ? void 0 : findIntegration.stripLinks) === null || _a === void 0 ? void 0 : _a.call(findIntegration)), picture: p.picture || '/no-picture.jpg', identifier: p.providerIdentifier, inBetweenSteps: p.inBetweenSteps, refreshNeeded: p.refreshNeeded, isCustomFields: !!findIntegration.customFields }, (findIntegration.customFields
    ...
    getIntegrationUrl(integration, refresh, externalUrl, redirectUrl, onboarding, org) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (redirectUrl) {
                    yield ioRedis.set(`redirect:${state}`, redirectUrl, 'EX', 3600);
                }
...
__decorate([
    ...
    __param(3, Query('redirectUrl')),
    __param(4, Query('onboarding')),
    __param(5, GetOrgFromRequest()),
    __metadata("design:type", Function),
