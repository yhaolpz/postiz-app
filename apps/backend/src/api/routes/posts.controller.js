...
import { PostValidationException } from "./posts.validation.exception";
let PostsController = class PostsController {
    ...
    getPostGroupDebugExport(org, user, group) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    validatePosts(org, rawBody) {
        return __awaiter(this, void 0, void 0, function* () {
            return this._postsService.validatePosts(org.id, (rawBody === null || rawBody === void 0 ? void 0 : rawBody.posts) || []);
        });
    }
    createPost(org, rawBody) {
        return __awaiter(this, void 0, void 0, function* () {
            // Server-side validation — never trust the client to have validated.
            const validation = yield this._postsService.validatePosts(org.id, (rawBody === null || rawBody === void 0 ? void 0 : rawBody.posts) || []);
            ...
            if ((rawBody === null || rawBody === void 0 ? void 0 : rawBody.type) !== 'draft') {
                for (const item of validation) {
                    if (!item.valid) {
...
__decorate([
    ...
    __param(0, GetOrgFromRequest()),
    __param(1, GetUserFromRequest()),
    __param(2, Param('group')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, String]),
    __metadata("design:returntype", Promise)
], PostsController.prototype, "getPostGroupDebugExport", null);
__decorate([
    Get('/group/:group'),
    __param(0, GetOrgFromRequest()),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], PostsController.prototype, "validatePosts", null);
__decorate([
    Post('/'),
