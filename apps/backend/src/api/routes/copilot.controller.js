...
let CopilotController = class CopilotController {
    ...
    agent(req, res, organization) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            requestContext.set('integrations', ((_c = (_b = (_a = req === null || req === void 0 ? void 0 : req.body) === null || _a === void 0 ? void 0 : _a.variables) === null || _b === void 0 ? void 0 : _b.properties) === null || _c === void 0 ? void 0 : _c.integrations) || []);
    ...
    getList(organization) {
        return __awaiter(this, void 0, void 0, function* () {
            const mastra = yield this._mastraService.mastra();
            const memory = yield mastra.getAgent('postiz').getMemory();
            const list = yield memory.listThreads({
