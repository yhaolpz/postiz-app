...
let UsersController = class UsersController {
    ...
    getChatbaseToken(user, organization) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!process.env.CHATBASE_TOKEN) {
                throw new HttpException('Chatbase SSO is not configured', 400);
            }
            const token = sign(Object.assign({ user_id: organization.id, email: user.email }, (organization.paymentId
                ? {
                    stripe_accounts: [
                        {
                ...
                : {})), process.env.CHATBASE_TOKEN, { expiresIn: '1h' });
            return { token };
        });
    }
    ...
    getSelf(user, organization, req) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // @ts-ignore
            return Object.assign(Object.assign({}, user), { orgId: organization.id, totalChannels: !process.env.STRIPE_PUBLISHABLE_KEY
                    ? 10000
                    : // @ts-ignore
                        ((_a = organization === null || organization === void 0 ? void 0 : organization.subscription) === null || _a === void 0 ? void 0 : _a.totalChannels) || pricing.FREE.channel, tier: 
                // @ts-ignore
                ((_b = organization === null || organization === void 0 ? void 0 : organization.subscription) === null || _b === void 0 ? void 0 : _b.subscriptionTier) ||
                    (!process.env.STRIPE_PUBLISHABLE_KEY ? 'ULTIMATE' : 'FREE'), 
                // @ts-ignore
                role: (_c = organization === null || organization === void 0 ? void 0 : organization.users[0]) === null || _c === void 0 ? void 0 : _c.role, 
                // @ts-ignore
                isLifetime: !!((_d = organization === null || organization === void 0 ? void 0 : organization.subscription) === null || _d === void 0 ? void 0 : _d.isLifetime), admin: !!user.isSuperAdmin, impersonate: !!impersonate, isTrailing: !process.env.STRIPE_PUBLISHABLE_KEY
                    ? false
                    : organization === null || organization === void 0 ? void 0 : organization.isTrailing, allowTrial: organization === null || organization === void 0 ? void 0 : organization.allowTrial, streakSince: (organization === null || organization === void 0 ? void 0 : organization.streakSince) || null, publicApi: 
                // @ts-ignore
                ((_e = organization === null || organization === void 0 ? void 0 : organization.users[0]) === null || _e === void 0 ? void 0 : _e.role) === 'SUPERADMIN' ||
                    // @ts-ignore
                    ((_f = organization === null || organization === void 0 ? void 0 : organization.users[0]) === null || _f === void 0 ? void 0 : _f.role) === 'ADMIN'
                    ? organization === null || organization === void 0 ? void 0 : organization.apiKey
                    : '' });
        });
    }
...
], UsersController.prototype, "getChatbaseToken", null);
__decorate([
    Get('/agent-media-sso'),
    __param(0, GetUserFromRequest()),
    __param(1, GetOrgFromRequest()),
