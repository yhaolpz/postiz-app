...
let NoAuthIntegrationsController = class NoAuthIntegrationsController {
    ...
    connectSocialMedia(integration, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _b = createUpdate, { token: _token, refreshToken: _refreshToken, customInstanceDetails: _customInstanceDetails } = _b, safeIntegration = __rest(_b, ["token", "refreshToken", "customInstanceDetails"]);
            return Object.assign(Object.assign(Object.assign(Object.assign({}, safeIntegration), { onboarding: onboarding === 'true', pages }), (returnURL ? { returnURL } : {})), (extensionToken ? { extensionToken } : {}));
        });
    }
