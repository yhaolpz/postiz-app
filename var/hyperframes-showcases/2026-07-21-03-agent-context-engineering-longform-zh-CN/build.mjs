...
<html lang="zh-CN">
  ...
  <body>
    <div data-hf-id="hf-main-root" id="root" data-composition-id="main" data-start="0" data-duration="${duration.toFixed(3)}" data-width="1920" data-height="1080">
      ...
      <header data-hf-id="hf-masthead" class="masthead content-layer"><div class="brand">Tiny Agent</div><h1 class="title">AI 智能体上下文：保留信号，减少噪声</h1></header>
...
async function compile() {
  ...
  await writeFile(path.join(projectRoot, 'summary.json'), `${JSON.stringify({
    ...
    output: { file: 'renders/2026-07-21-03-agent-context-engineering-longform.zh-CN.mp4', status: 'pending' },
  }, null, 2)}\n`);
