# Tiny Agent Agent Task Brief — English long-form explainer

## Format

- Canvas: 1920 x 1080, 16:9, 30 fps.
- Target: a complete English explainer that turns real-work handoff requirements into a reusable six-field Agent Task Brief.
...
6. The edge-to-edge 52 px chapter rail uses actual narration timings and continuous labels such as 1. Introduction and 2. Artifact First.
