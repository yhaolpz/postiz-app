...
function renderPhaseV2(scene, index) {
  if (scene.recap) {
    ...
    const summaryTitle = scene.finalSummary ? 'Choose the mode\nKeep judgment' : scene.chapter;
...
<html lang="en-US">
  ...
  <body>
    <div data-hf-id="hf-main-root" id="root" data-composition-id="main" data-start="0" data-duration="${duration.toFixed(3)}" data-width="1920" data-height="1080">
      ...
      <header data-hf-id="hf-masthead" class="masthead"><div class="brand">Tiny Agent</div><h1 class="title">Which AI Work Mode Fits?</h1></header>
...
async function compile() {
  ...
  await writeFile(path.join(projectRoot, 'summary.json'), `${JSON.stringify({
    title: 'Ask, Collaborate, Explore, or Delegate?',
    source: sourcePath,
    language: 'en-US',
    ...
    output: { file: 'renders/2026-07-18-ai-work-modes-longform.en-US.mp4', status: 'pending' },
  }, null, 2)}\n`);
