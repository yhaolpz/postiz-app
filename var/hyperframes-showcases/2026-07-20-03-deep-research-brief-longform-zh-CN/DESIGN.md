# Tiny Agent 深度研究任务模板 — Chinese long-form explainer

## Format

- Canvas: 1920 x 1080, 16:9, 30 fps.
- Target: a complete Chinese explainer that turns a fuzzy research question into a reusable six-field 深度研究任务模板.
...
6. The edge-to-edge 52 px chapter rail uses actual narration timings and continuous labels such as 1. 前言 and 2. 决策优先.
