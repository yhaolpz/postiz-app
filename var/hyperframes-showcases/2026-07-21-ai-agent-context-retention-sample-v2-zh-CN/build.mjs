...
function generateTts() {
  ...
  const checkpoints = {
    coverFirstFrame: 0,
    coverHardCut: 0.8,
    questionEnd: last('hook').spokenEnd,
    firstSentenceEnd: last('hook').spokenEnd,
