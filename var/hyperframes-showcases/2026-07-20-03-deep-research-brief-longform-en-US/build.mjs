...
function renderPhaseV2(scene, index) {
  if (scene.recap) {
    ...
    const summaryTitle = scene.finalSummary ? 'Use the Research Brief\nTurn evidence into a decision' : scene.chapter;
    const summaryCta = '';
    return `
...
<html lang="en-US">
  ...
  <body>
    <div data-hf-id="hf-main-root" id="root" data-composition-id="main" data-start="0" data-duration="${duration.toFixed(3)}" data-width="1920" data-height="1080">
      ...
      <header data-hf-id="hf-masthead" class="masthead content-layer"><div class="brand">Tiny Agent</div><h1 class="title">The Research Brief</h1></header>
...
async function compile() {
  ...
  await writeFile(path.join(projectRoot, 'summary.json'), `${JSON.stringify({
    title: 'The Decision-Ready Research Brief',
    source: sourcePath,
    language: 'en-US',
    ...
    output: { file: 'renders/2026-07-20-03-deep-research-brief-longform.en-US.mp4', status: 'pending' },
  }, null, 2)}\n`);
