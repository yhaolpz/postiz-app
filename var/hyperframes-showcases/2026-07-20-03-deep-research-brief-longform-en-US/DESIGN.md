# Tiny Agent Decision-Ready Research Brief — English long-form explainer

## Format

- Canvas: 1920 x 1080, 16:9, 30 fps.
- Target: a complete English explainer that turns a fuzzy research question into a reusable six-field Decision-Ready Research Brief.
...
6. The edge-to-edge 52 px chapter rail uses actual narration timings and continuous labels such as 1. Introduction and 2. Decision First.
...
- Inter for English copy and the Tiny Agent brand.
