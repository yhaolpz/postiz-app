# Tiny Agent Agent 任务委托单 — Chinese long-form explainer

## Format

- Canvas: 1920 x 1080, 16:9, 30 fps.
- Target: a complete Chinese explainer that turns real-work handoff requirements into a reusable six-field Agent 任务委托单.
...
6. The edge-to-edge 52 px chapter rail uses actual narration timings and continuous labels such as 1. 前言 and 2. 先定产物.
