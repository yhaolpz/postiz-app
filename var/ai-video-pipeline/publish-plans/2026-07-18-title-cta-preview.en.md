# Tiny Agent title and CTA screen verification plan

### 2026-07-18 Sat - When the Steps Are Unknown
...
- Keyframes:
  ...
  - A dedicated follow screen with one large smiling Tiny Agent waving and pointing toward a simple blue plus symbol; no programmer, content diagram, calendar, source card, citation symbol, title, or embedded text.
...
- YouTube Shorts title: When the Steps Are Unknown
