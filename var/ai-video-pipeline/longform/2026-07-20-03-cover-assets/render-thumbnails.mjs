...
const enDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-20-03-deep-research-brief-longform-en-US/thumbnails');
const zhDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-20-03-deep-research-brief-longform-zh-CN/thumbnails');
...
const enBodyBase = `${canvas(1280, 720)}<image x="835" y="88" width="405" height="540" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`;
const enTitle = `<g fill="#111413" font-family="Arial Black, Arial, sans-serif" font-weight="900" letter-spacing="-4"><text x="42" y="176" font-size="112">TURN</text><text x="42" y="340" font-size="138">RESEARCH</text><text x="42" y="468" font-size="96">INTO A</text><text x="42" y="616" font-size="142">DECISION</text></g>`;
...
const zhVariants = [
  {
    ...
    image: `<image x="820" y="88" width="420" height="548" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="9" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-3"><text x="48" y="272" font-size="110">别只收集资料</text><text x="48" y="510" font-size="134">要支持决策</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="825" y="248" width="340" height="420" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="11" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="245" font-size="240">别只</text><text x="38" y="535" font-size="188">收集资料</text><text x="38" y="825" font-size="150">要支持决策</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="230" y="748" width="440" height="436" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="13" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="245" font-size="240">别只</text><text x="38" y="475" font-size="190">收集资料</text><text x="38" y="672" font-size="154">要支持决策</text></g>`,
...
for (const variant of zhVariants) {
  ...
  write(path.join(zhDir, `thumbnail-spec.zh-CN.${variant.ratio}.json`), `${JSON.stringify({
    ...
    titleLines: variant.ratio === '16x9' ? ['别只收集资料', '要支持决策'] : ['别只', '收集资料', '要支持决策'],
...
write(path.join(enDir, 'thumbnail-spec.en-US.16x9.json'), `${JSON.stringify({
  ...
  headline: 'TURN RESEARCH INTO A DECISION', titleLines: ['TURN', 'RESEARCH', 'INTO A', 'DECISION'],
