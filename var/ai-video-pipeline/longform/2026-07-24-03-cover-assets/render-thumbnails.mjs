...
const enDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-24-03-ai-agent-action-permissions-longform-en-US/thumbnails');
const zhDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-24-03-ai-agent-action-permissions-longform-zh-CN/thumbnails');
...
const enHeadline = 'AI AGENT AUTO ASK OR BLOCK';
const enBodyBase = `${canvas(1280, 720)}<image x="900" y="168" width="340" height="340" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.png"/>`;
const enTitle = `<g fill="#111413" font-family="Arial Black, Arial, sans-serif" font-weight="900" letter-spacing="-4"><text x="42" y="194" font-size="128">AI AGENT</text><text x="42" y="390" font-size="140">AUTO, ASK</text><text x="42" y="594" font-size="146">OR BLOCK?</text></g>`;
...
const zhTitleText = 'AI 智能体自动·确认·阻断';
const zhVariants = [
  {
    ratio: '16x9', width: 1280, height: 720, output: 'thumbnail.zh-CN.png', base: 'base.zh-CN.png', svgName: 'thumbnail.zh-CN.svg',
    image: `<image x="888" y="200" width="340" height="340" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="8" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-3"><text x="48" y="218" font-size="118">AI 智能体</text><text x="48" y="408" font-size="118">自动·确认</text><text x="48" y="596" font-size="132">·阻断</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="844" y="318" width="314" height="314" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="11" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="245" font-size="132">AI 智能体</text><text x="38" y="510" font-size="168">自动·确认</text><text x="38" y="785" font-size="194">·阻断</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="226" y="744" width="648" height="420" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="13" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="184" font-size="150">AI 智能体</text><text x="38" y="428" font-size="194">自动·确认</text><text x="38" y="680" font-size="226">·阻断</text></g>`,
...
for (const variant of zhVariants) {
  ...
  write(path.join(zhDir, `thumbnail-spec.zh-CN.${variant.ratio}.json`), `${JSON.stringify({
    ...
    headline: zhTitleText, titleLines: ['AI 智能体', '自动·确认', '·阻断'],
    baseImage: variant.base, illustration: 'illustration.png', illustrationFit: 'contain',
...
write(path.join(enDir, 'thumbnail-spec.en-US.16x9.json'), `${JSON.stringify({
  ...
  headline: enHeadline, titleLines: ['AI AGENT', 'AUTO, ASK', 'OR BLOCK?'], titleIdentity: true,
  titleBox: enTitleBox, textVisualBudget: '60-70%', illustrationVisibleFootprint: '30-40%',
  baseImage: 'base.en-US.png', illustration: 'illustration.png', illustrationFit: 'contain',
