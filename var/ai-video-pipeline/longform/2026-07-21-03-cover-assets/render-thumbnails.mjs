...
const enDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-21-03-agent-context-engineering-longform-en-US/thumbnails');
const zhDir = path.join(repoRoot, 'var/hyperframes-showcases/2026-07-21-03-agent-context-engineering-longform-zh-CN/thumbnails');
...
const enHeadline = 'GIVE AI AGENTS HIGH-SIGNAL CONTEXT';
const enBodyBase = `${canvas(1280, 720)}<image x="806" y="154" width="445" height="414" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`;
const enTitle = `<g fill="#111413" font-family="Arial Black, Arial, sans-serif" font-weight="900" letter-spacing="-4"><text x="42" y="154" font-size="148">GIVE</text><text x="42" y="296" font-size="140">AI AGENTS</text><text x="42" y="438" font-size="108">HIGH-SIGNAL</text><text x="42" y="608" font-size="142">CONTEXT</text></g>`;
const enDecor = `<rect x="44" y="40" width="176" height="14" rx="7" fill="#117ABD"/><rect x="44" y="660" width="684" height="18" rx="9" fill="#FFD04A"/>`;
...
const zhTitleText = '给 AI 智能体高信号上下文';
const zhVariants = [
  {
    ratio: '16x9', width: 1280, height: 720, output: 'thumbnail.zh-CN.png', base: 'base.zh-CN.png', svgName: 'thumbnail.zh-CN.svg',
    image: `<image x="795" y="156" width="435" height="410" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="8" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-3"><text x="48" y="292" font-size="126">给 AI 智能体</text><text x="48" y="512" font-size="130">高信号上下文</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="778" y="308" width="384" height="374" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="11" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="220" font-size="172">给 AI 智能体</text><text x="38" y="515" font-size="224">高信号</text><text x="38" y="820" font-size="238">上下文</text></g>`,
  ...
  },
  {
    ...
    image: `<image x="76" y="748" width="748" height="420" preserveAspectRatio="xMidYMid meet" xlink:href="illustration.subject-cutout.png"/>`,
    title: `<g fill="#111413" stroke="#ECECEA" stroke-width="13" stroke-linejoin="round" paint-order="stroke" font-family="Hiragino Sans GB, PingFang SC, sans-serif" font-weight="900" letter-spacing="-4"><text x="38" y="188" font-size="150">给 AI 智能体</text><text x="38" y="438" font-size="232">高信号</text><text x="38" y="690" font-size="246">上下文</text></g>`,
...
for (const variant of zhVariants) {
  ...
  write(path.join(zhDir, `thumbnail-spec.zh-CN.${variant.ratio}.json`), `${JSON.stringify({
    ...
    headline: zhTitleText, titleLines: variant.ratio === '16x9' ? ['给 AI 智能体', '高信号上下文'] : ['给 AI 智能体', '高信号', '上下文'],
...
write(path.join(enDir, 'thumbnail-spec.en-US.16x9.json'), `${JSON.stringify({
  ...
  headline: enHeadline, titleLines: ['GIVE', 'AI AGENTS', 'HIGH-SIGNAL', 'CONTEXT'], titleIdentity: true,
