...
let RefreshIntegrationService = class RefreshIntegrationService {
    ...
    refresh(integration_1) {
        return __awaiter(this, arguments, void 0, function* (integration, cause = '') {
            const socialProvider = this._integrationManager.getSocialIntegration(integration.providerIdentifier);
            const refresh = yield this.refreshProcess(integration, socialProvider, cause);
            if (!refresh) {
                return false;
            }
    ...
    setBetweenSteps(integration_1) {
        return __awaiter(this, arguments, void 0, function* (integration, cause = '') {
            yield this._integrationService.setBetweenRefreshSteps(integration.id);
            yield this._integrationService.informAboutRefreshError(integration.organizationId, integration, cause);
        });
    }
    ...
    refreshProcess(integration_1, socialProvider_1) {
        return __awaiter(this, arguments, void 0, function* (integration, socialProvider, cause = '') {
