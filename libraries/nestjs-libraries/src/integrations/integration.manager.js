...
import { CnblogsProvider } from "./social/cnblogs.provider";
        ...
        return __awaiter(this, void 0, void 0, function* () {
            return {
                social: yield Promise.all(socialIntegrationList.map((p) => __awaiter(this, void 0, void 0, function* () {
                    return (Object.assign(Object.assign({ name: p.name, identifier: p.identifier, toolTip: p.toolTip, editor: p.editor, isExternal: !!p.externalUrl, isWeb3: !!p.isWeb3, isChromeExtension: !!p.isChromeExtension }, (p.extensionCookies
                        ? { extensionCookies: p.extensionCookies }
                        : {})), (p.customFields ? { customFields: yield p.customFields() } : {})));
                }))),
                article: [],
            };
        });
