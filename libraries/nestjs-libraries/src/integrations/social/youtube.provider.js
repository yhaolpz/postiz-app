...
let YoutubeProvider = class YoutubeProvider extends SocialAbstract {
    ...
    findPlaylistByTitle(youtubeClient, title) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const normalizedTitle = title.trim().toLowerCase();
            let pageToken;
            do {
                const response = yield youtubeClient.playlists.list({
                    part: ['id', 'snippet'],
                    mine: true,
                    maxResults: 50,
                    pageToken,
                });
                const playlist = (_a = response.data.items) === null || _a === void 0 ? void 0 : _a.find((item) => { var _a, _b; return ((_b = (_a = item.snippet) === null || _a === void 0 ? void 0 : _a.title) === null || _b === void 0 ? void 0 : _b.trim().toLowerCase()) === normalizedTitle; });
                if (playlist === null || playlist === void 0 ? void 0 : playlist.id) {
                    return playlist.id;
                }
    ...
    createPlaylist(youtubeClient, title, privacyStatus) {
        return __awaiter(this, void 0, void 0, function* () {
            const response = yield youtubeClient.playlists.insert({
    ...
    addVideoToPlaylist(youtubeClient, videoId, settings) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            const playlistTitle = (_a = settings.playlistTitle) === null || _a === void 0 ? void 0 : _a.trim();
            let playlistId = (_b = settings.playlistId) === null || _b === void 0 ? void 0 : _b.trim();
            if (!playlistId && playlistTitle) {
                playlistId =
                    (yield this.findPlaylistByTitle(youtubeClient, playlistTitle)) ||
                        (yield this.createPlaylist(youtubeClient, playlistTitle, settings.playlistPrivacyStatus || 'public'));
            }
            if (!playlistId) {
                return;
            }
            try {
                yield youtubeClient.playlistItems.insert({
                    part: ['snippet'],
                    requestBody: {
                        snippet: {
                            playlistId,
                ...
                const body = JSON.stringify(((_c = error === null || error === void 0 ? void 0 : error.response) === null || _c === void 0 ? void 0 : _c.data) || error);
    ...
    handleErrors(body) {
        ...
        if (body.includes('invalidDescription')) {
            return {
                type: 'bad-body',
                value: 'Your video description is invalid, it may contain disallowed characters such as < or >.',
            };
        }
        ...
        if (body.includes('defaultLanguageNotSet')) {
            return {
                type: 'bad-body',
                value: 'We could not set the localized video details because no default language is set.',
            };
        }
        if (body.includes('invalidVideoMetadata')) {
            return {
                type: 'bad-body',
                value: 'Some of the video details are invalid, please review the title, description and tags.',
            };
        }
        if (body.includes('mediaBodyRequired')) {
            return {
                type: 'bad-body',
                value: 'The video file is missing or could not be read, please re-upload the video.',
            };
        }
        if (body.includes('imageFormatUnsupported')) {
            return {
                type: 'bad-body',
                value: 'We have uploaded your video but the thumbnail format is not supported, please use JPEG or PNG.',
            };
        }
        if (body.includes('imageTooTall')) {
            return {
                type: 'bad-body',
                value: 'We have uploaded your video but the thumbnail image is too tall.',
            };
        }
        if (body.includes('imageTooWide')) {
            return {
                type: 'bad-body',
                value: 'We have uploaded your video but the thumbnail image is too wide.',
            };
        }
        if (body.includes('rateLimitExceeded')) {
            return {
                type: 'bad-body',
                value: 'You are sending requests too quickly, please wait a little while and try again.',
            };
        }
    ...
    post(id, accessToken, postDetails) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (((_d = all === null || all === void 0 ? void 0 : all.data) === null || _d === void 0 ? void 0 : _d.id) && (settings.playlistId || settings.playlistTitle)) {
                yield this.runInConcurrent(() => __awaiter(this, void 0, void 0, function* () { return this.addVideoToPlaylist(youtubeClient, all.data.id, settings); }));
            }
            return [
                {
                    id: firstPost.id,
                    releaseURL: `https://www.youtube.com/watch?v=${(_e = all === null || all === void 0 ? void 0 : all.data) === null || _e === void 0 ? void 0 : _e.id}`,
                    postId: (_f = all === null || all === void 0 ? void 0 : all.data) === null || _f === void 0 ? void 0 : _f.id,
                    status: 'success',
                },
            ];
        });
