...
let StripeService = class StripeService {
    ...
    createEmbeddedCheckout(ud, uniqueId, customer, body, price, userId, allowTrial) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { client_secret } = yield stripe.checkout.sessions.create(Object.assign(Object.assign({ ui_mode: 'custom', customer, return_url: process.env['FRONTEND_URL'] +
                    `/launches?onboarding=true&trialStart=true&check=${uniqueId}${isUtm}`, mode: 'subscription', subscription_data: Object.assign(Object.assign({}, (allowTrial ? { trial_period_days: 7 } : {})), { metadata: Object.assign(Object.assign({ service: 'gitroom' }, body), { userId,
                        uniqueId,
    ...
    chatbaseRefundPreview(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c, _d, _e, _f, _g;
            const org = yield this._organizationService.getOrgById(organizationId);
            if (!(org === null || org === void 0 ? void 0 : org.paymentId)) {
            ...
            let lastCharge = undefined;
            let chargeSubscription = undefined;
            for (const charge of charges) {
                ...
                try {
                    ...
                    const invoiceSubscription = (_b = (_a = invoice.parent) === null || _a === void 0 ? void 0 : _a.subscription_details) === null || _b === void 0 ? void 0 : _b.subscription;
                    const subscriptionId = typeof invoiceSubscription === 'string'
                        ? invoiceSubscription
                        : invoiceSubscription === null || invoiceSubscription === void 0 ? void 0 : invoiceSubscription.id;
            ...
            const interval = (_g = (_f = (_e = (_d = (_c = chargeSubscription.items) === null || _c === void 0 ? void 0 : _c.data) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.price) === null || _f === void 0 ? void 0 : _f.recurring) === null || _g === void 0 ? void 0 : _g.interval;
            // maximum refund is one month worth of the subscription
            const amount = interval === 'year'
                ? Math.floor(lastCharge.amount / 12)
                : lastCharge.amount;
            const currentSubscription = yield this._subscriptionService.getSubscriptionByOrganizationId(organizationId);
            return {
                eligible: true,
                chargeId: lastCharge.id,
                amount: amount / 100,
                currency: lastCharge.currency,
                tier: (currentSubscription === null || currentSubscription === void 0 ? void 0 : currentSubscription.subscriptionTier) || null,
                period: (currentSubscription === null || currentSubscription === void 0 ? void 0 : currentSubscription.period) || null,
                subscriptionIds: subscriptions.map((f) => f.id),
            };
        });
    }
    chatbaseRefund(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            const preview = yield this.chatbaseRefundPreview(organizationId);
            if (!preview.eligible) {
                return {
                    refunded: false,
            ...
            if (preview.subscriptionIds.length) {
                yield this._subscriptionService.deleteSubscription(org === null || org === void 0 ? void 0 : org.paymentId);
            }
            return {
                refunded: true,
