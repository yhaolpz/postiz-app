...
export const getTemporalModule = (isWorkers, path, activityClasses) => {
    ...
    const divider = Math.max(1, Number(process.env.WORKER_CONCURRENCY_DIVIDER) || 1);
    return TemporalModule.register(Object.assign({ isGlobal: true, connection: Object.assign(Object.assign(Object.assign({ address: process.env.TEMPORAL_ADDRESS || 'localhost:7233' }, (process.env.TEMPORAL_TLS === 'true' ? { tls: true } : {})), (process.env.TEMPORAL_API_KEY
            ? { apiKey: process.env.TEMPORAL_API_KEY }
            : {})), { namespace: process.env.TEMPORAL_NAMESPACE || 'default' }), taskQueue: 'main', logLevel: 'error' }, (isWorkers
        ? {
            workers: [
                ...
                const concurrency = integration.maxConcurrentJob
                    ...
                    : undefined;
                return Object.assign({ taskQueue, workflowsPath: path, activityClasses: activityClasses, autoStart: true }, (concurrency
                    ? {
                        workerOptions: {
