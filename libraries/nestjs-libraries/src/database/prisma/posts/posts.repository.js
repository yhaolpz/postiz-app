...
import { APPROVED_SUBMIT_FOR_ORDER, State, } from '@prisma/client';
...
let PostsRepository = class PostsRepository {
    ...
    getPostsList(orgId, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const stateAndDate = stateFilter === 'scheduled'
                ? {
                    state: State.QUEUE,
                }
                : stateFilter === 'draft'
            ...
            const orderDirection = stateFilter === 'published' ? 'desc' : 'asc';
            const where = Object.assign(Object.assign(Object.assign({ AND: [
                    {
                        OR: [
                            {
                                organizationId: orgId,
                ...
                ] }, stateAndDate), (stateFilter === 'published'
                ? {}
                : { publishDate: { gte: dayjs.utc().toDate() } })), { deletedAt: null, parentPostId: null, intervalInDays: null, integration: Object.assign({ deletedAt: null, organizationId: orgId }, (query.customer
                    ? {
                        customerId: query.customer,
                    }
                    : {})) });
    ...
    createOrUpdatePost(state, orgId, date, body, tags, creationMethod, inter) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a;
            const posts = [];
            const uuid = uuidv4();
            for (const value of body.value) {
                const updateData = (type) => {
                    var _a, _b;
                    return (Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({ publishDate: dayjs(date).toDate(), integration: {
                            connect: {
                        ...
                        : type === 'update'
                            ...
                            : {})), { content: value.content, delay: value.delay || 0, group: uuid, intervalInDays: inter ? +inter : null, approvedSubmitForOrder: APPROVED_SUBMIT_FOR_ORDER.NO }), (type === 'create' ? { creationMethod } : {})), (state === 'update'
                        ? {}
                        : {
