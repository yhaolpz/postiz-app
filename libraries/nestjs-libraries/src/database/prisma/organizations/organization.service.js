...
let OrganizationService = class OrganizationService {
    ...
    inviteTeamMember(orgId, body) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (body.sendEmail) {
                yield this._notificationsService.sendEmail(body.email, 'You have been invited to join an organization', `You have been invited to join an organization. Click <a href="${url}">here</a> to join.<br />The link will expire in 2 days.`);
            }
            return { url };
        });
    }
