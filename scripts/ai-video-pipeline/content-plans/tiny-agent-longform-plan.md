...
| 2026-07-29 | OpenAI：[Using skills](https://openai.com/academy/skills/)，2026-04-10                                                                                                                                  | 怎样把一次成功经验变成下次还能复用的能力？        | Skill 模板                 | 质量门槛阻塞（RUN_KEY `2026-07-27-03`）：场景/旁白时间轴不一致，开场契约未完成；英文未发布              |
