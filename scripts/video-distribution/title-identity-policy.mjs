...
const approvedCodexCX11 = Object.freeze({
  titleCandidates: Object.freeze([
  ...
  publisher: 'OpenAI',
  sourceTitle: 'Codex as a platform; Code review; Model optimization',
  sourceUrl: 'https://developers.openai.com/blog/codex-as-a-platform',
  publicationDate: '2026-08-19',
  releaseTag: 'rust-v0.150.1',
  sourceCommit: '90854393966b21e9ebfd21b122334eb09a20c93d',
...
const approvedCodexCX13 = Object.freeze({
  titleCandidates: Object.freeze([
  ...
  publisher: 'OpenAI',
  sourceTitle:
    'Codex as a platform; Introducing upgrades to Codex; Codex Security',
  sourceUrl: 'https://developers.openai.com/blog/codex-as-a-platform',
  publicationDate: '2026-08-19',
  releaseTag: 'rust-v0.150.1',
  sourceCommit: '90854393966b21e9ebfd21b122334eb09a20c93d',
...
const approvedCodexCX14 = Object.freeze({
  titleCandidates: Object.freeze([
  ...
  publisher: 'OpenAI',
  sourceTitle: 'Codex as a platform; Add evals to your AI app',
  sourceUrl: 'https://developers.openai.com/blog/codex-as-a-platform',
  publicationDate: '2026-08-19',
  releaseTag: 'rust-v0.150.1',
  sourceCommit: '90854393966b21e9ebfd21b122334eb09a20c93d',
...
function isApprovedCodexCX11(text, metadata) {
  return (
    approvedCodexCX11.titleCandidates.includes(String(text || '')) &&
    metadata?.source?.publisher === approvedCodexCX11.publisher &&
    metadata?.source?.title === approvedCodexCX11.sourceTitle &&
    metadata?.source?.url === approvedCodexCX11.sourceUrl &&
    metadata?.source?.publicationDate === approvedCodexCX11.publicationDate &&
    metadata?.source?.releaseTag === approvedCodexCX11.releaseTag &&
    metadata?.source?.sourceCommit === approvedCodexCX11.sourceCommit
  );
}
...
function isApprovedCodexCX13(text, metadata) {
  return (
    approvedCodexCX13.titleCandidates.includes(String(text || '')) &&
    metadata?.source?.publisher === approvedCodexCX13.publisher &&
    metadata?.source?.title === approvedCodexCX13.sourceTitle &&
    metadata?.source?.url === approvedCodexCX13.sourceUrl &&
    metadata?.source?.publicationDate === approvedCodexCX13.publicationDate &&
    metadata?.source?.releaseTag === approvedCodexCX13.releaseTag &&
    metadata?.source?.sourceCommit === approvedCodexCX13.sourceCommit
  );
}

function isApprovedCodexCX14(text, metadata) {
  return (
    approvedCodexCX14.titleCandidates.includes(String(text || '')) &&
    metadata?.source?.publisher === approvedCodexCX14.publisher &&
    metadata?.source?.title === approvedCodexCX14.sourceTitle &&
    metadata?.source?.url === approvedCodexCX14.sourceUrl &&
    metadata?.source?.publicationDate === approvedCodexCX14.publicationDate &&
    metadata?.source?.releaseTag === approvedCodexCX14.releaseTag &&
    metadata?.source?.sourceCommit === approvedCodexCX14.sourceCommit
  );
}
